...
const AddAlbum = ({isOpen, closeModal})=>{
return(
    ...
    <>
        <div className={`modal ${isOpen ? "" : "hidden"}  place-content-center fixed z-10 inset-0 flex`} style={{backgroundColor: "gray", width: "100%", height: "100%", background:"rgba(0,0,0,0.5)"}}>
            <div className="rounded-lg bg-white lg:w-[40rem] h-[25rem] min-h-[2rem] mt-5">
                ...
                <div className="px-2 grid lg:md:grid-cols-2 sm:grid-cols-1">
                    <div className="flex">
                        ...
                        <input className="w-[80%] rounded-md h-[2rem] border-2 border-black-600 hover:border-blue-300 m-3"  placeholder="Album Name"></input>
                    </div>
                    <div className="flex">
