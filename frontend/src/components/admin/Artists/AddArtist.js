...
const AddArtist = ({isOpen, closeModal})=>{
return(
            ...
            <div className="rounded-lg bg-white lg:min-w-[40rem] h-[20rem] min-h-[4rem] mt-5">
                ...
                <div className="">
                    <div className="flex px-2">
                        ...
                        <input className="w-[80%] rounded-md h-[2rem] border-2 border-black-600 hover:border-blue-300 m-3"  placeholder="Artist Name"></input>
                    </div>
                    <div className="flex px-2">
