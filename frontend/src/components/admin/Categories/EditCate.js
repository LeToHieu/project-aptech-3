...
const EditCate = ({isOpen, closeModal})=>{
return(
            ...
            <div className="rounded-lg bg-white lg:min-w-[40rem] h-[20rem] min-h-[4rem] mt-5">
                ...
                <div className="">
                    <div className="flex px-2">
                        <label className="flex w-[7rem] justify-start items-center">Name: </label>
                        <input className="w-[80%] rounded-md h-[2rem] border-2 border-black-600 hover:border-blue-300 m-3"  placeholder="Categories Name"></input>
                    </div>
                    <div className="flex px-2">
                        <label className=" flex w-[7rem] pt-3 justify-start">Description: </label>
                        <textarea className="w-[80%] h-[8rem] rounded-md h-[2rem] border-2 border-black-600 hover:border-blue-300 m-3"  placeholder="Categories Description"></textarea>
                    </div>
                </div>
