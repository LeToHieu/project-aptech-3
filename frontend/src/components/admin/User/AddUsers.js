        ...
        <div className="rounded-lg bg-white lg:w-[40rem] lg:h-[20rem] mt-5">
            ...
            <div className="grid lg:md:grid-cols-2 sm:grid-cols-1 px-3">
                ...
                <div className="flex">
                    ...
                    <input className="w-[13rem] rounded-md h-[2rem] border-2 border-black-600 hover:border-blue-300 m-3"  placeholder="Email Address"></input>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                    <label className="w-[4rem] flex items-center justify-center" >Image: </label>
                    <input type='file'  className="text-sm w-[13rem] h-[2rem] m-3"  placeholder="Address"></input>
                </div>
                <div className="flex">
