...
const SignUp = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    Object.entries(myRegiUser).forEach(([key, value]) => {
  ...
  return (
    <form
      style={{ width: "66.66666666667%", display: "flex" }}
    ...
    >
      <div className="loginInsideForm" style={{ width: "100%" }}>
        <div className="field">
          ...
          <FontAwesomeIcon
            icon={faCheck}
            className={validName ? "valid" : "offscreen"}
          />
          <FontAwesomeIcon
            icon={faTimes}
            className={validName || !name ? "offscreen" : "invalid"}
          />
        </div>
        <p
          id="uidnote"
        ...
        <div className="field">
          ...
          <FontAwesomeIcon
            icon={faCheck}
            className={validEmail ? "valid" : "offscreen"}
          />
          <FontAwesomeIcon
            icon={faTimes}
            className={validEmail || !email ? "offscreen" : "invalid"}
          />
        </div>
        <div className="field">
          <input
          ...
          <FontAwesomeIcon
            icon={faCheck}
            className={validPhoneNumber ? "valid" : "offscreen"}
          />
          <FontAwesomeIcon
            icon={faTimes}
            className={
              validPhoneNumber || !phoneNumber ? "offscreen" : "invalid"
            }
          />
        </div>
      ...
      <div className="loginInsideForm" style={{ width: "100%" }}>
        <p
          style={{ color: "#a445b2", cursor: "pointer" }}
          onClick={props.signupBackBtn}
        >
          Back
        </p>
        ...
        <div className="field" style={{ marginTop: "0.1rem" }}>
          ...
          <FontAwesomeIcon
            icon={faCheck}
            className={address ? "valid" : "offscreen"}
          />
          <FontAwesomeIcon
            icon={faTimes}
            className={
              !!address || homeAddressFocus !== true ? "offscreen" : "invalid"
            }
          />
        </div>
        ...
        <div className="field">
          ...
          <FontAwesomeIcon
            icon={faCheck}
            className={validPassword ? "valid" : "offscreen"}
          />
          <FontAwesomeIcon
            icon={faTimes}
            className={validPassword || !password ? "offscreen" : "invalid"}
          />
        </div>
