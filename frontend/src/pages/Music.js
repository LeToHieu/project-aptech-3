      ...
      <div className="music h-[100%] overflow-y-auto">
        <div className="py-8 px-20 bg-black box-border text-white shrink-0 min-h-[100%] pb-40">
          <div className="mt-10 w-full">
            <h2 className="sm:text-3xl font-bold">Ca sĩ yêu thích của bạn</h2>
            <div className="flex gap-2 mt-4 overflow-auto ">
              {musics.map((music) => {
                return (
                  <div className="text-center shrink-0">
                    <img
                      src={"https://localhost:7023/resources/" + music?.artist.artistImage}
                      alt=""
                      className="my-3 rounded-full w-[180px] h-[180px] object-cover"
                    />
                    <p className="font-bold">{music?.artist.artistName}</p>
                  </div>
                )
              })}
            </div>
